...
2. Host inicia la sesión
3. Se seleccionan 5 mini-juegos aleatoriamente
...
## 9. Cómo Agregar un Nuevo Mini-Juego
...
| **MiniGame** | Juego individual (Cooperar/Traicionar, Votación, etc.) |
...
- ✅ 3 mini-juegos implementados (Cooperar/Traicionar, Quien Sobra, Quien Merece)
